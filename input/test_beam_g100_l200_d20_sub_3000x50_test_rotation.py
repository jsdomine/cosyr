...
run_name = "beam_benchmark_g100_l200_d20_sub_pm10_3000steps_3000x50_test_rotation"

## electron and trajectory
gamma=100
lbeam = 200   # beam length, in um
dbeam = 20   # beam diameter, in um
#psi_max = 0.3/3000   # max retarded 
...
num_dirs =  1                      # number of field lines
num_step = 30000                   # number of steps (currently always equal to num_wavefronts)
dt = psi_max/num_step  # time step in electron rest frame
emission_interval = 8 #num_step-1     # only emit wavefronts at simulation end (test purpose)
emission_start = num_step - (num_wavefronts-1)*emission_interval
print("emission_start: {}".format(emission_start))

## remap
remap_interval = num_step - emission_interval        # interval of doing remapping (in time steps)
...
## load wavelets
##cosyr_root = './'
#cosyr_root = '/Users/huangck/Documents/Work/CSR/2019-ER/gitlab/cosyr/subcycle_wavelet'
##cosyr_root = '/global/homes/h/huangck/Work/cosyr_benchmark/wavelets'
##path2subcycling = cosyr_root + "/g100-200x200um-sub_3000x50_clip_pm200"
#path2subcycling = cosyr_root + "/g100-200x200um-sub_clip_pm10"
# path2subcycling = "../input/wavelets/g100-200x200um-sub"
# wavelet_x, wavelet_y, wavelet_field = load_wavelets(path2subcycling, X_coord_file="scaled_xprime_sub.csv", Y_coord_file="scaled_yprime_sub.csv", fld_file="EBRad_sub.csv", unscale_coord=True, _gamma = gamma, broadcast=False)
#if (mpi_rank==0) :
...
beam_output_interval = 1000 #num_step-2 
mesh_output_interval = num_step - emission_interval
wavelet_output_interval = num_step - emission_interval
beam_output = True
if (mpi_rank==0):
